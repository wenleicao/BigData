...
public class JasonLineReader {
	  ...
	  public JasonLineReader (InputStream in) {
	   ...
	   * @throws IOException
	   */
	  public JasonLineReader(InputStream in, int bufferSize) {
		    this.in = in;
	   ...
	   * @throws IOException
	   */
	  public JasonLineReader(InputStream in, Configuration conf) throws IOException {
